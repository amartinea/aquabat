...
class SaleReport(models.Model):
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            ...
            s.id as order_id,
            sum(l.price_reduce_taxexcl * l.qty_delivered / CASE COALESCE(s.currency_rate, 0) WHEN 0 THEN 1.0 ELSE s.currency_rate END) as billable_total,
            sum((l.price_reduce_taxexcl - l.purchase_price) * l.qty_delivered / CASE COALESCE(s.currency_rate, 0) WHEN 0 THEN 1.0 ELSE s.currency_rate END) as billable_marge
        """
