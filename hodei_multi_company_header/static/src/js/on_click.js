...
SwitchCompanyMenu.include({
    _onClick: function (ev) {
        ...
        if (companyID == 1)
        {
            ev.currentTarget.parentElement.parentElement.parentElement.parentElement.removeClass('header-company-marsan').addClass('header-company-negoce');
        }
        else if (companyID == 3)
        {
            ev.currentTarget.parentElement.parentElement.parentElement.parentElement.removeClass('header-company-negoce').addClass('header-company-marsan');
        }
        this._rpc({
            model: 'res.users',
            method: 'write',
